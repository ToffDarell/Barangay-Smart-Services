...
>
    <div class="px-6 py-6 border-b border-white/5">
        <div class="flex items-center justify-between">
            <a href="{{ route('landing') }}" class="flex items-center gap-3">
                <div class="rounded-full bg-teal-800 p-1">
                    <div class="bg-teal-500 rounded-full w-8 h-8 flex items-center justify-center">
                        <div class="w-4 h-4 bg-[#383443] rounded-full"></div>
                    </div>
                </div>
                <div>
                    <h2 class="font-display text-[17px] font-bold leading-tight text-white tracking-wide">BrgySphere<br><span class="text-[9px] font-medium uppercase tracking-widest text-gray-400 mt-0.5">Barangay Sample</span></h2>
                </div>
            </a>
    ...
    <nav class="mt-2 flex-1 space-y-1 px-4">
        <a href="{{ route('dashboard') }}" class="admin-sidebar-link {{ request()->routeIs('dashboard') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
        ...
        <a href="{{ route('residents.index') }}" class="admin-sidebar-link {{ request()->routeIs('residents.*') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
        ...
        <a href="{{ route('certificates.index') }}" class="admin-sidebar-link {{ request()->routeIs('certificates.*') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
        ...
        <a href="{{ route('reports.index') }}" class="admin-sidebar-link {{ request()->routeIs('reports.*') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
        ...
        <a href="{{ route('announcements.index') }}" class="admin-sidebar-link {{ request()->routeIs('announcements.*') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
        ...
        <a href="{{ route('users.index') }}" class="admin-sidebar-link {{ request()->routeIs('users.*') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
        ...
        <div class="pt-1">
            <button type="button" @click="settingsOpen = !settingsOpen" class="admin-sidebar-link w-full justify-between {{ request()->routeIs('settings.*') ? 'bg-[#7c3aed] text-white font-medium rounded-lg shadow-[0_4px_12px_rgba(124,58,237,0.2)]' : 'text-gray-300 hover:text-white font-medium hover:bg-white/5 rounded-lg' }}">
